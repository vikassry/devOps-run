...
aws elasticbeanstalk create-application-version --application-name "My First Elastic Beanstalk Application" --version-label bootDemo-$TRAVIS_BUILD_NUMBER.zip --description application-v1 --source-bundle S3Bucket="spring-boot-jeetu",S3Key="bootDemo-$TRAVIS_BUILD_NUMBER.zip"
